...
val OtherWorksSectionGridStyle = CssStyle {
    ...
    Breakpoint.MD { // 2 columns for medium screens
        Modifier
            .gridTemplateColumns { repeat(2) { size(1.fr) } }
    }
    Breakpoint.LG { // 3 columns for large screens
        Modifier
...
fun OtherWorksSection(
    ...
    Section(
        ...
        Column(
            ...
            Column(
                modifier = OtherWorksSectionGridStyle.toModifier()
            ) {
                // 3 WorkCards for the "Other works" section
                repeat(3) {
                    WorkCard(
